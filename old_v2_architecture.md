...
**Script**: `scripts/preprocess_nifti_to_multiclass.py`
...
**Script**: `scripts/convert_to_lmdb.py`
...
│   │
│   ├── losses_combined.py             # Ultimate loss (CURRENT)
│   ├── multiclass_metrics.py          # Metrics computation
│   │
│   └── utils/
...
# Load config
cfg = load_config('configs/phase2_a100.yaml')
