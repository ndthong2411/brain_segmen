...
**Configuration** ([`configs/phases/phase1_optimized.yaml`](configs/phases/phase1_optimized.yaml)):
```yaml
...
**File**: [`configs/phases/phase1_optimized.yaml`](configs/phases/phase1_optimized.yaml)
...
### New Files Created:
1. **`configs/phases/phase1_optimized.yaml`** - Complete Phase 1 configuration
...
1. **Validation Run** (Quick test):
   ```bash
   python scripts/train.py --cfg configs/phases/phase1_optimized.yaml --fold 0
   ```
...
2. **Full Training** (If validation successful):
   ...
   # A100 80GB
   python scripts/train.py --cfg configs/phases/phase1_optimized.yaml --fold 0
   python scripts/train.py --cfg configs/phases/phase1_optimized.yaml --fold 1
   python scripts/train.py --cfg configs/phases/phase1_optimized.yaml --fold 2
   ```
   - Run all 5 folds
