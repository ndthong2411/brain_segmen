...
│   ├── hardware/a100.yaml              ✅ Hardware config
...
| File | Purpose | Status |
|------|---------|--------|
| `losses/base.py` | General loss functions | ✅ Core |
| `losses/boundary.py` | Boundary loss | ✅ Core |
| `losses/combined.py` | Combined/composite losses | ✅ Core |
| `losses/iou.py` | IoU loss | ✅ Core |
| `losses/multiclass.py` | Multi-class losses | ✅ Core |
| `metrics/base.py` | General metrics | ✅ Core |
| `metrics_multiclass.py` | Multi-class metrics | ✅ Core |
| `metrics/multiclass.py` | Duplicate? | ⚠️ Check |

**Issues**:
- ⚠️ **8 files scattered in root** instead of organized in subfolders
- ⚠️ **Possible duplicate**: `metrics_multiclass.py` vs `metrics/multiclass.py`
...
- `hardware/a100.yaml` ✅ A100 optimizations
...
│   │   │   ├── __init__.py
│   │   │   ├── base.py                 ← Renamed from losses/base.py
│   │   │   ├── boundary.py             ← Renamed from losses/boundary.py
│   │   │   ├── combined.py             ← Renamed from losses/combined.py
│   │   │   ├── iou.py                  ← Renamed from losses/iou.py
│   │   │   └── multiclass.py           ← Renamed from losses/multiclass.py
│   │   │
│   │   ├── metrics/                    ← NEW: Organized metrics
│   │   │   ├── __init__.py
│   │   │   ├── base.py                 ← Renamed from metrics/base.py
...
│   │   │   └── a100.yaml               ← Renamed from hardware/a100.yaml
│   │   │
...
git mv losses/base.py losses/base.py
git mv losses/boundary.py losses/boundary.py
git mv losses/combined.py losses/combined.py
git mv losses/iou.py losses/iou.py
git mv losses/multiclass.py losses/multiclass.py
```
...
```powershell
git mv metrics/base.py metrics/base.py
git mv metrics_multiclass.py metrics/multiclass.py

# Check if metrics/multiclass.py is duplicate
...
```powershell
git mv hardware/a100.yaml hardware/a100.yaml
```
