...
\textbf{Loss weights}: Dice 1.0, focal 1.0 ($\gamma=3.0$, $\alpha=[0.0, 0.4, 0.3]$), IoU 2.5, boundary 0.6, deep supervision 0.3, classification 0.5. Class weights: [1.0, 3.0, 4.0].
